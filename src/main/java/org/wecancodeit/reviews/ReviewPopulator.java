...
public class ReviewPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Category caribbean = new Category("Caribbean", "Caribbean description");
		caribbean = categoryRepo.save(caribbean);

		Category europe = new Category("Europe", "Europe description");
		europe = categoryRepo.save(europe);

		Category nationalParks = new Category("National Parks", "National Parks description");
		nationalParks = categoryRepo.save(nationalParks);

		Review cancun = new Review("Cancun", "Here are some resorts in Cancun. Resort 1. Resort 2. Resort 3.",
		...
		Review jamaica = new Review("Jamaica", "Here are some resorts in Jamaica. Resort 1. Resort 2. Resort 3.",
		...
		Review guatemala = new Review("Guatemala", "Here are some hotels in Guatemala. Hotel 1. Hotel 2. Hotel 3.",
		...
		Review amsterdam = new Review("Amsterdam", "Here are some hotels in Amsterdam. Hotel 1. Hotel 2. Hotel 3.",
		...
		Review france = new Review("France", "Here are some hotels in France. Hotel 1. Hotel 2. Hotel 3.",
		...
		Review italy = new Review("Italy", "Here are some hotels in Italy. Hotel 1. Hotel 2. Hotel 3.", "Ea man bun "
		...
		Review grandCanyon = new Review("Grand Canyon",
				"Here are some hotels near the Grand Canyon. Hotel 1. Hotel 2. Hotel 3.",
		...
		Review everglades = new Review("Everglades",
				"Here are some hotels near the Everglades. Hotel 1. Hotel 2. Hotel 3.",
